		...
		<div class="step_box_content">
			<div class="step_box_content_flex border borderBottom">
				...
				<div class="step_box_right step_box_right_button">
					<div
						class="icon_boolean"
						:class="{ true: stepData.az_2_linchuang_tidan }"
		...
		<div class="step_box_content">
			...
			<div class="step_box_content_flex border borderBottom">
				...
				<div class="step_box_right step_box_right_button">
					<div
						class="icon_boolean"
						:class="{ true: stepData.az_2_linchuang_pizhun }"
		...
		<div class="step_box_content">
			<div class="step_box_content_flex border borderBottom">
				...
				<div class="step_box_right step_box_right_button">
					<div
						class="icon_boolean"
						:class="{ true: stepData.az_2_zhaobiao }"
		...
		<div class="step_box_content">
			<div class="step_box_content_flex border borderBottom">
				...
				<div class="step_box_right step_box_right_button">
					<div
						class="icon_boolean"
						:class="{ true: stepData.conx_2_zhaobiao_zhunbei }"
