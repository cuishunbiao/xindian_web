<template>
		...
		<div class="step_box_content">
			<div class="step_box_content_flex border borderBottom">
				...
				<div class="step_box_right step_box_right_button">
					<div
						class="icon_boolean"
						:class="{ true: stepData.lianmeng_1_tz_status }"
						@click="isBooleanFn('lianmeng_1_tz_status', stepData.lianmeng_1_tz_status)"
					></div>
				</div>
			</div>
			<div class="step_box_content_flex border borderBottom">
				...
				<div class="step_box_right">
					<select class="step_box_right_select" v-model="stepData.lianmeng_1_tz_type">
						<option value="-1">请选择通知形式</option>
			...
			<div class="step_box_content_flex">
				...
				<div class="step_box_right">
					<div ref="tongzhiTime" id="tongzhiTime" class="select-tab-bg">请选择时间</div>
				</div>
			</div>
		</div>
		<div class="step_box_content">
		...
		<div class="step_box_content">
			<div class="step_box_content_flex border borderBottom">
				...
				<div class="step_box_right step_box_right_button">
					<div
						class="icon_boolean"
						:class="{ true: stepData.lianmeng_1_baoming }"
						@click="isBooleanFn('lianmeng_1_baoming', stepData.lianmeng_1_baoming)"
					></div>
				</div>
			</div>
		</div>
		...
		<div class="step_box_content">
			<div class="step_box_content_flex">
				...
				<div class="step_box_right step_box_right_button">
					<div
						class="icon_boolean"
						:class="{ true: stepData.az_1_fangan }"
						@click="isBooleanFn('az_1_fangan', stepData.az_1_fangan)"
					></div>
				</div>
			</div>
		</div>
		...
		<div class="step_box_content">
			<div class="step_box_content_flex">
				...
				<div class="step_box_right step_box_right_button">
					<div
						class="icon_boolean"
						:class="{ true: stepData.az_conx_1_xiangxi_fangan }"
						@click="isBooleanFn('az_conx_1_xiangxi_fangan', stepData.az_conx_1_xiangxi_fangan)"
					></div>
				</div>
			</div>
		</div>
		...
		<div class="step_box_content">
			<div class="step_box_content_flex">
				...
				<div class="step_box_right step_box_right_button">
					<div
						class="icon_boolean"
						:class="{ true: stepData.az_conx_1_xiangxi_queren }"
						@click="isBooleanFn('az_conx_1_xiangxi_queren', stepData.az_conx_1_xiangxi_queren)"
					></div>
				</div>
			</div>
		</div>
	...
	<div class="info_footer">
		<button class="info_submit">下一步阶段2</button>
	</div>
</template>
...
const stepData = reactive<stepDataTS>({
	lianmeng_1_tz_status: false,
	lianmeng_1_tz_type: '',
	lianmeng_1_tz_time: '',
	lianmeng_1_yuanfang_name: '',
	lianmeng_1_yuanfang_zhiwei: '',
	lianmeng_1_yuanfang_fankui: '',
	lianmeng_1_baoming: false,
	az_1_fangan: false,
	az_1_yuanfang_name: '',
	az_1_yuanfang_zhiwei: '',
	az_1_yuanfang_fankui: '',
	az_1_xiangxi_fangan: false,
	az_1_xiangxi_fankui: '',
	az_1_xiangxi_queren: false,
	conx_1_xiangxi_fangan: false,
	conx_1_xiangxi_fankui: '',
	conx_1_xiangxi_queren: '',
	az_conx_1_xiangxi_fangan: false,
	az_conx_1_xiangxi_fankui: '',
	az_conx_1_xiangxi_queren: false
})
...
const selectTimeFn = () => {
	...
	new MobileSelect({
		...
		callback: function (indexArr: Number, data: any) {
			...
			tongzhiTime.value.innerHTML = `${data[0]}-${data[1]}-${data[2]} ${data[3]}:${data[4]}`
		}
	})
}

// 解构
const { lianmeng_1_yuanfang_fankui, az_1_yuanfang_fankui, az_conx_1_xiangxi_fankui } = { ...toRefs(stepData) }
